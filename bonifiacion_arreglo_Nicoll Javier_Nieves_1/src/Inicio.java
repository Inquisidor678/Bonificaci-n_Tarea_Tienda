...
public class Inicio {
    public static void main(String[] args) {
        ...
        int opcion;
        int tam;
        Nacional[] listaProductosNal = null;
        Importado[] listaProductosImp = null;

        do {
            System.out.println("---------------------------");
            System.out.println("BIENVENIDOS A TIENDAS jAV");
            System.out.println("---------------------------");
            ...
            switch (opcion) {
                case 1:
                    System.out.println("Por favor digita el numero de productos: ");
                    tam = snc.nextInt();
                    listaProductosNal = new Nacional[tam];
                    ...
                    break;
                case 2:
                    System.out.println("Por favor digita el numero de productos importados que desea agregar: ");
                    tam = snc.nextInt();
                    listaProductosImp = new Importado[tam];
